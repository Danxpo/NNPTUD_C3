...
router.post('/', async function (req, res, next) {
  try {
    // Thêm check xem "name" có được truyền lên không, nếu không báo lỗi chứ KHÔNG THEO MẠCH XỬ LÝ DƯỚI NỮA
    if (!req.body.name) {
      return res.status(400).send({ message: "Thiếu trường 'name' bắt buộc" });
    }
